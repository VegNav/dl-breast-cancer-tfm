...
def train_and_eval_efficientnetB3_cft(data_dir, num_epochs=50, num_workers=4):
    batch_size = 32
    learning_rate = 1e-4
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                if epoch_loss < best_val_loss:
                    ...
                    torch.save(model.state_dict(), os.path.join(save_dir, 'best_efficientnetB3CFT.pth'))
                else:
                    patience_counter += 1
